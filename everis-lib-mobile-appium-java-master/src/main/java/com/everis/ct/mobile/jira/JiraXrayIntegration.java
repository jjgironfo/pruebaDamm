...
import static com.everis.ct.mobile.service.io.ManageFiles.getJsonContentAsString;
import static com.everis.ct.mobile.service.io.ManageFiles.readAsString;
...
public class JiraXrayIntegration extends JiraProperties {
    ...
    private void importResults(String jwtToken, String cucumberJsonPath) {
        ...
        if (cucumberJsonPath.equals(Constants.NOT_DEFINED))
            jsonContentAsString = getJsonContentAsString(String.format(CUCUMBER_JSON_PATH, defaultCucumberJsonPath));
        else
            jsonContentAsString = getJsonContentAsString(String.format(CUCUMBER_JSON_PATH, cucumberJsonPath));
