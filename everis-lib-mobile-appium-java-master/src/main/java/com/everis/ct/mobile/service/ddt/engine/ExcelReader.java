package com.everis.ct.mobile.service.ddt.engine;
...
import static com.everis.ct.mobile.service.datamanage.ValidateSessionData.getValueIntoDDTFormat;
import static com.everis.ct.mobile.service.datamanage.ValidateSessionData.isDDtParameterFormat;
    ...
    public DataTable check(DataTable dataTable) {
        ...
        for (String value : dataTable.cells().get(1))
            valuesBuilder.append("\"").append(
                    check(UtilMobile.replaceBlank(value))
            ).append("\"").append(",");
